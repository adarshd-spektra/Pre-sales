...
| Lab | Topic | Duration |
|-----|-------|----------|
| Lab 1 | Users, Groups, and Least Privilege: accounts, password policy, offboarding, sudo | 20 Minutes |
| Lab 2 | File Permissions and Sensitive Data: modes, umask, SUID | 20 Minutes |
